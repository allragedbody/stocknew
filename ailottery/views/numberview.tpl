...
<html style="height: 100%">
  ...
  <div id="numberlist"> 出号机：</div>
  <div id="numberlist"> 出号机：</div>

  <div id="selectnum"> 选号：
  <button type="button" class="datapushbtn" id="datapush">自动换号</button>
  <div id="secondpoint"> 手工选号：
  </div>
  <div class="datapush">
	<button type="button" class="datapushbtn" id="datapush">确定</button>
  </div>
  </div>
